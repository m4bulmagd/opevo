...
const SAFE_BACKEND_MESSAGES = {
  ...
  phone_already_assigned: "A Opevo number is already assigned to this account.",
  ...
  phone_not_ready: "Your Opevo number is not ready yet.",
  ...
  go_live_blocked: "Opevo is not ready to go live. Review the remaining activation steps.",
